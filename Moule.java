...
class Moule {
	...
	public int getIDMoule() {
		...
		System.out.println("x :" + this.posX + 1 + "y: " + this.posY * this.tailleX + "add: "
				+ (this.posX + 1 + this.posY * this.tailleX));
	...
	public void remplirCase(int idCase) {
		...
		if (getCaseRight(idCase - 1) != 10 && getCaseUp(idCase - 1) != 10 && getCaseDown(idCase - 1) != 10
				&& getCaseLeft(idCase - 1) != 10) {
